<template>
    ...
    <div class="home">
        <div class="home-content">
            ...
            <p>Właścicielem strony internetowej szambonalata.pl.pl jest firma Szambo Na Lata, która jest administratorem Twoich danych osobowych.</p>
            <p>Niniejsza Polityka prywatności określa, w jaki sposób przetwarzamy informacje gromadzone na stronie szambonalata.pl, a także wyjaśnia powody, dla których musimy gromadzić określone dane o użytkowniku.</p>
            <p>Dlatego przed rozpoczęciem korzystania ze strony szambonalata.pl zapoznaj się z niniejszą Polityką Prywatności.</p>
            ...
            <p>Jeżeli chcesz się z nami skontaktować, aby uzyskać więcej informacji na temat niniejszej Polityki Prywatności lub w jakiejkolwiek sprawie mającej związek z Twoimi prawami i danymi osobowymi, możesz wysłać wiadomość e-mail na adres biuro.szambonalata@gmail.com.</p>
        </div>
    </div>
    <MainFooter />
</template>
